...
const SOCIAL_LINKS = [
  ...
  { label: 'Instagram', href: 'https://www.instagram.com/grupomaxpesaoficial/', icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z"/></svg> },
      ...
      <div className="container">
        <div className={styles.grid}>
          ...
          <div className={styles.col}>
            <h5>Serviços</h5>
            <ul>
              <li><Link to="/servicos#movimentacao">Movimentação de Cargas</Link></li>
              <li><Link to="/servicos#amarela">Linha Amarela</Link></li>
              <li><Link to="/servicos#remocao">Remoção Industrial</Link></li>
              <li><Link to="/servicos#locacao">Locação &amp; Venda</Link></li>
            </ul>
          </div>
